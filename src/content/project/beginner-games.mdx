...
description: Typically these games made for those between the ages of 8-14
intro:  Find the game you've been looking for
features:
  - name: Year
    value: "2045"
  - name: Skills
...
blocks:
  - type: text_image
    ...
    template: column
    class: " py-20 "
    title: Games specifically for those between the ages of 8-14
    reverse: false
    ...
    content: >
      ...
      Dice Wizard games are a great way to introduce your child to the world of gaming. A flavour of D&D that focuses on cooperation, teamwork, and creativity. 
    block_class: py-20
    image_size: "50"
    animate: true
  - type: text_image
...
style:
  ...
  card_template: grid
  hero_image_opacity: ""
thumbnail: /src/assets/evil-game1.png
